...
simu.simMechanicsFile = 'Spheroid.slx';   % Simulink Model File
...
%% Body Data
% Float
body(1) = bodyClass('./hydroData/spheroid_f3676.h5');
body(1).geometryFile = './geometry/spheroid_f3676.stl';
body(1).mass =536.69;                           % [kg]
body(1).inertia = [53.67, 134.17, 134.17];      % [kg m^2]
